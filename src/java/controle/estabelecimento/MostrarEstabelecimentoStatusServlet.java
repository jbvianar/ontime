 ...
 */
public class MostrarEstabelecimentoStatusServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Estabelecimento> resultado = estabelecimentoNegocio.mostrarStatus();
        request.setAttribute("resultado", resultado);
        RequestDispatcher rd = request.getRequestDispatcher("WEB-INF/pages/cabecalho.jsp");
